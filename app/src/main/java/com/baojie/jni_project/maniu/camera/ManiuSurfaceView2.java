...
public class ManiuSurfaceView2 extends SurfaceView implements SurfaceHolder.Callback, Camera.PreviewCallback {
    private Camera.Size size;
    private Camera mCamera;
    private MediaCodec mediaCodec;
    public ManiuSurfaceView2(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initCodec() {
        try {
            ...
            MediaFormat mediaFormat = MediaFormat.createVideoFormat(MediaFormat.MIMETYPE_VIDEO_AVC, size.height, size.width);
